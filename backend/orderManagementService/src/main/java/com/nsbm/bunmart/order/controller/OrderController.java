...
public class OrderController {
    ...
    public ResponseEntity<PaymentIntentResponseDTO> requestPaymentIntent(@PathVariable Integer id) {
    ...
    @PostMapping("/{id}/paid")
    public ResponseEntity<OrderResponseDTO> markOrderPaid(@PathVariable Integer id) {
    ...
    public ResponseEntity<ProduceOrderResponseDTO> produceOrder(@PathVariable Integer id) {
    ...
    @PostMapping("/{id}/ship")
    public ResponseEntity<ShipOrderResponseDTO> shipOrder(@PathVariable Integer id) {
