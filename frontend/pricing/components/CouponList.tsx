          ...
          <table className="w-full">
            <thead className="bg-primary/5">
              <tr>
                ...
                <th className="px-6 py-3 text-left text-xs font-bold text-[#8a7960] uppercase tracking-wider">Usage</th>
            ...
            <tbody className="divide-y divide-primary/10">
              {coupons.map((coupon) => (
                <tr key={coupon.id} className="hover:bg-primary/5">
                  <td className="px-6 py-4 text-sm font-bold text-[#181511] dark:text-white font-mono">{coupon.code}</td>
